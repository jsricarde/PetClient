angular.module('petClient.controllers', [])
  ...
  /*
   * This is the AccountController function for manage user detail template view
   */
  ...
  /*
   * This is the AccountEditController function for manage user template view
   */
  .controller('AccountEditController', ['user_detail', '$state', '$scope', 'userFactory', '$cordovaGeolocation', '$http', '$ionicPopup', 'ionicDatePicker', function (user_detail, $state, $scope, userFactory, $cordovaGeolocation, $http, $ionicPopup, ionicDatePicker) {
    $scope.button = "Update";
    $scope.title = "Update account";

    angular.element(field_password).remove();
        //set data model
    $scope.registerData = {
      id: user_detail._id,
    ...
    $scope.showAlert = function () {
      $ionicPopup.alert({
        ...
        content: 'The user to update the'
      }).then(function (res) { });
    };
    ...
    $scope.doSubmitUser = function () {
      userFactory.updateUser($scope.registerData).success(function (data) {
        console.log(data);
        $scope.showAlert();
        $scope.registerData = {};
